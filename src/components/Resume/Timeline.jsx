              ...
              >
                <div className="flex flex-col gap-1">
                  ...
                  <p>
                    ...
                    leading a Tech4Good project, playing a crucial role in a
                    major UK postal client project, and participating in early
                    talent promotional videos.
                  </p>
                  <div className="flex gap-2 flex-wrap text-[.6rem] w-fit font-bold mt-2">
              ...
              >
                <div className="flex flex-col gap-1">
                  ...
                  <p>
                    ...
                    monthly subscription. And create a network of supporters to
